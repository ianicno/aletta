...
<body class="royal_loader">
	...
	<section id="section1" class="parallax-bg1 hero parallax clearfix">
		...
		<div class="shortcode clearfix">
			...
			if(@$_POST['upload']){
				$allowed_ext	= array('doc', 'docx','ppt', 'pptx', 'pdf', 'rar', 'zip');
				...
				if(in_array($file_ext, $allowed_ext) === true){
					if($file_size < 2044070){
						...
						echo"<script>alert('Besar ukuran file (file size) maksimal 1 Mb!');</script>";
					}
				}else{
			...
			<form action="" enctype="multipart/form-data" method="post" name="form">
             ...
             <tr>
					<td height="75px">
					<strong><font color="#d32127">Nama *</font></strong><br/><font color="#ffffff">Silahkan menuliskan nama lengkap anda</font><br/>
					<input name="nama" id="nama" type="text" class="form-control" size="30" required="required">
					</td>
					</tr>
					<tr>
					<td height="100px">
					<strong><font color="#d32127">Email *</font></strong><br/><font color="#ffffff">Silahkan menuliskan username atau email yang sudah terdaftar di BerryOutlet</font><br/>
					<input name="email" id="email "type="email" class="form-control"size="30" required="required">
					</td>
					</tr>
					<tr>
					<td height="75px">
					<strong><font color="#d32127">No handphone *</font></strong><br/><font color="#ffffff">Silahkan menuliskan nomor anda yang masih aktif</font>
					<br/>
					<input name="phone" id="phone" type="text" class="form-control"size="30" required="required">
					</td>
					</tr>
					<tr>
					<td height="55px">
					<strong><font color="#d32127">Aletta *</font></strong><br/><font color="#ffffff">Silahkan upload gambar Aletta anda. Gambar dibuat dalam versi PDF dengan mencantumkan nama, email, no hp, dan deskripsi gambar serta komposisi warna. Max 2 MB</font>
